...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\columnwidth]{newImg/20241129_153124.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\columnwidth]{newImg/20241129_153147.jpg}
    \caption{Own Image, Marker on Wall \cite{tim-schweitzer}}
    \label{fig:example-appendix3}
\end{figure}
\begin{figure}[htbp]
    \centering
