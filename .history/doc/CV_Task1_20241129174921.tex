...
\begin{thebibliography}{9}
    ...
    \bibitem{v_speed}
    v\_speed. \textit{Poster used in Images}, 2024. Available under Pixabay-Contentlicenz license: \url{https://pixabay.com/de/photos/beijing-automotive-bj40-suv-bj80-2486704/}. Accessed: November 3, 2024, 18:01.

    \bibitem{fireimg}
    NASA-Imagery. \textit{Poster used a Fire}, 2024. Available under Pixabay-Contentlicenz license:\url{https://pixabay.com/de/photos/sonneneruption-sonnenlicht-eruption-978/}. Accessed: November 20, 2024, 16:55.
\end{thebibliography}
...
\begin{figure}[htbp]
    ...
    \caption{Poster used for the own Images\cite{fireimg}}
    \label{fig:img-poster}
\end{figure}
